            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('end_customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>end_customer</Th>
                  )}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('end_customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.end_customer}</Td>
                    )}
                    {hasAccess('sales_representative', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.sales_representative}</Td>
                    )}
                    {hasAccess('team_member', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
